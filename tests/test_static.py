...
class StaticRepoTests(unittest.TestCase):
    ...
    def test_release_docs_require_exact_tag_compatibility_validation(self):
        ...
        self.assertIn('Backup, restore, and rollback | 🟡 `v1.4.0` pending exact-tag evidence; ✅ `v1.3.1` exact-tag and packaged-artifact evidence', readiness)
        self.assertIn('Browser-facing login | 🟡 `v1.4.0` pending exact-tag evidence; ✅ `v1.3.1` exact-tag and packaged-artifact evidence', readiness)
        self.assertIn('No-lock-in Compose operation | 🟡 `v1.4.0` pending exact-tag evidence; ✅ `v1.3.1` exact-tag and packaged-artifact evidence', readiness)
        self.assertIn('`v1.4.0` release-validation state', readiness)
        self.assertIn('`v1.3.1` release-validation state', readiness)
        self.assertIn('Latest published manager release | `v1.3.1`', readiness)
        self.assertIn('Next manager release | `v1.4.0` (publication and exact-tag validation pending)', readiness)
        ...
        self.assertIn('latest validated-compatible release', deployment)
        ...
        self.assertIn('No-lock-in behavior passed exact-tag and packaged-artifact validation for `v1.3.1`', deployment)
        self.assertIn('The `--proxy-bind-address` option is new in the pending `v1.4.0` release and is not available in `v1.3.1`', deployment)
    ...
    def test_security_policy_exists_and_guides_private_reporting(self):
        ...
        self.assertIn('`v1.4.0` release preparation on `main` | Security reports are accepted; publication and exact-tag compatibility validation are pending.', security)
        self.assertIn('`v1.3.1` | Current published stable release and latest validated-compatible artifact', security)
    ...
    def test_v1_4_release_is_pending_and_v1_3_1_evidence_is_preserved(self):
        ...
        self.assertIn('Latest validated | `v1.3.1`', readme)
        ...
        self.assertIn('git checkout v1.3.1', readme)
        self.assertNotIn('git checkout v1.4.0', readme)
        self.assertIn('`v1.0.0` release tag', readme)
        self.assertIn('✅ Validated compatible', readme)
        self.assertIn('| `v1.4.0` release tag | `v2.5.44` | `v3.0.9` | `v1.2` | 🟡 Pending validation | — | — |', compatibility)
        self.assertIn('`v1.4.0` remains pending publication and full validation', compatibility)
        ...
        self.assertIn('| `v1.4.0` release tag | `v2.5.44` | `v3.0.9` | `v1.2` | 🟡 Pending validation | — | — | — | — | — | — |', matrix)
        ...
        self.assertEqual(channels['latest_published'], 'v1.3.1')
        self.assertEqual(channels['latest_validated'], 'v1.3.1')
