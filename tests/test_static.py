...
class StaticRepoTests(unittest.TestCase):
    ...
    def test_release_docs_require_exact_tag_compatibility_validation(self):
        ...
        self.assertIn('Latest published manager release | `v1.4.0`', readiness)
    ...
    def test_security_policy_exists_and_guides_private_reporting(self):
        ...
        self.assertIn('`v1.4.0` | Current published stable release; exact-tag/package-artifact compatibility validation is in progress.', security)
        self.assertIn('`v1.3.1` | Latest validated-compatible artifact', security)
    ...
    def test_v1_4_release_is_pending_and_v1_3_1_evidence_is_preserved(self):
        ...
        self.assertIn('The immutable `v1.4.0` tag and operator-bundle artifact are published, but full exact-tag/package-artifact validation remains in progress.', compatibility)
        ...
        self.assertEqual(channels['latest_published'], 'v1.4.0')
