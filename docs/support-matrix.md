...
This page defines the public support scope of the stable release line. `v1.4.1` is the latest published and current validated-compatible release for the documented component tuple.
...
| Lifecycle helpers | install, doctor, login check, healthcheck, anonymous SOS report, backup, restore, update, reset dry-run, restore-based rollback, no-lock-in Compose usage | Exact `v1.4.1` compatibility is validated for the component tuple listed in the compatibility matrix. |
