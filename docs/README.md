...
`v1.2.0` is both the latest published and latest validated release for the documented component tuple. Its published operator-bundle artifact passed the lifecycle validation matrix for the documented scope.
