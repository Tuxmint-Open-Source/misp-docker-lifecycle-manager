...
> [!IMPORTANT]
> The `v1.0.0` release tag is validated compatible with MISP core `v2.5.43`, modules `v3.0.8`, and guard `v1.2`. Future upstream component sets require separate validation before compatibility is claimed.
>
