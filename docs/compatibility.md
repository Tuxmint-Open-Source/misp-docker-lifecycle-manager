...
| `v1.3.0` release tag | `v2.5.44` | `v3.0.9` | `v1.2` | ✅ Validated compatible | 2026-07-23 | [`compatibility-v1.3.0-misp-core-v2.5.44.md`](validation/compatibility-v1.3.0-misp-core-v2.5.44.md) |
| `v1.2.0` release tag | `v2.5.44` | `v3.0.9` | `v1.2` | ✅ Validated compatible | 2026-07-22 | [`compatibility-v1.2.0-misp-core-v2.5.44.md`](validation/compatibility-v1.2.0-misp-core-v2.5.44.md) |
...
| `v1.0.0-rc.3` release candidate tag | `v2.5.43` | `v3.0.8` | `v1.2` | ✅ Validated compatible | 2026-07-15 | [`compatibility-v1.0.0-rc.3-misp-core-v2.5.43.md`](validation/compatibility-v1.0.0-rc.3-misp-core-v2.5.43.md) |
...
> [!IMPORTANT]
> `v1.4.0` is pending full validation as an immutable tag and published operator-bundle artifact. `v1.3.1` remains the latest validated-compatible release, and `v1.3.0` and `v1.2.0` remain retained historical validated evidence. PR-branch evidence remains capability evidence only and is not a substitute for exact-tag validation.
>
