...
| --- | ---: | ---: | ---: | --- | --- | --- |
| `v1.3.0` release tag | `v2.5.44` | `v3.0.9` | `v1.2` | 🟡 Pending validation | — | — |
...
> [!IMPORTANT]
> `v1.3.0` is pending exact-tag and packaged-artifact validation. `v1.2.0` remains the latest validated-compatible release and retained evidence. PR-branch evidence remains capability evidence only and is not a substitute for exact-tag validation.
>
