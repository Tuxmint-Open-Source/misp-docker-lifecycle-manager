...
| inspect the current validated component tuple | [Compatibility](compatibility.md), [current validation](validation/compatibility-v1.4.0-misp-core-v2.5.44.md), and [validation matrix](validation/matrix.md) |
