# Compatibility validation: v1.4.1 with MISP core v2.5.44
...
The disposable validation environment was returned to a clean state after the gate completed.

## Notes and limitations

- The result applies only to the listed manager release and official component tuple.
- `v1.4.1` is a documentation/hosted-docs patch release; the validation still used the published artifact to preserve community-trust evidence parity with `v1.4.0`.
