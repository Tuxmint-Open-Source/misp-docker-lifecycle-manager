...
| --- | --- |
| `v1.4.1` | Current published and latest validated-compatible release for the documented component tuple. |
| `v1.4.0` | Previous stable release with retained compatibility evidence. |
