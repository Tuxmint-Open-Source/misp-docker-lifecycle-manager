...
| --- | --- |
| `v1.3.0` | Current stable release line; compatibility validation pending for the documented component tuple. Security reports are accepted and confirmed manager vulnerabilities are considered for a fix release. |
| `v1.2.0` | Latest validated-compatible artifact and previous stable release evidence. |
