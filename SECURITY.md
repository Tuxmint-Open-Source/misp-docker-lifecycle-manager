...
| --- | --- |
| `v1.4.0` release preparation on `main` | Security reports are accepted; publication and exact-tag compatibility validation are pending. |
| `v1.3.1` | Current published stable release and latest validated-compatible artifact for the documented component tuple. |
